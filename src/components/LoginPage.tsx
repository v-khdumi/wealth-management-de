...
export function LoginPage({ onLogin }: LoginPageProps) {
  ...
  return (
    <main
      ...
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-primary/5 to-accent/10 p-4 sm:p-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring"
    >
      <div className="w-full max-w-4xl py-4 sm:py-8">
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-accent mb-6">
            <Sparkle size={40} weight="duotone" className="text-white" aria-hidden="true" />
          </div>
          <h1 id="login-title" className="text-3xl sm:text-5xl font-display font-bold text-primary mb-4">
            My Wealth Dashboard
          </h1>
        ...
        <Card className="max-w-lg mx-auto shadow-xl">
          <CardHeader>
            <CardTitle id="persona-title" className="text-2xl">Choose a Demo Persona</CardTitle>
            <CardDescription id="persona-description">
          ...
          <CardContent>
            <form
              ...
              aria-describedby="persona-description demo-disclosure"
              className="space-y-6"
              onSubmit={(event) => {
            ...
            >
              <div className="space-y-2">
                ...
                <Select value={selectedUserId} onValueChange={setSelectedUserId}>
                  <SelectTrigger id="user-select" aria-describedby="persona-description" className="h-12 w-full">
        ...
        <p id="demo-disclosure" className="text-center text-sm text-muted-foreground mt-8">
